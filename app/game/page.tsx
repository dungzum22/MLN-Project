...
export default function Game() {
  // Khởi tạo với bộ câu hỏi mặc định; sẽ xáo trộn sau khi mount
  ...
  // Khởi tạo: sẽ gọi AI sau khi định nghĩa hàm generateQuestionsWithAI
  ...
  // Xáo trộn một lần khi mount để tránh lặp trình tự câu hỏi
  useEffect(() => {
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <div className="flex items-center justify-between gap-4 mb-4">
            ...
            {/* Hidden status removed per request */}
          </div>
        </motion.div>
